...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((ImageButton) findViewById(R.id.goAppListButton)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent("com.vimers.smartblock.activity_app_list"));
            }
        });
        ((ImageButton) findViewById(R.id.completeSettingsButton)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
